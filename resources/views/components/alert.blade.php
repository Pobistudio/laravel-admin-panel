@if (session()->has('alert'))
    ...
    <div class="absolute top-4 right-4 z-50">
        <div {{ $attributes->merge(['class' => "flex flex-col $bgColor border $borderColor $textColor px-4 py-3 rounded relative mb-4 transition duration-300 w-[300px] rounded-xl shadow-lg gap-2"]) }} role="alert" id="alert-{{ uniqid() }}">
