...
$.extend( true, DataTable.ext.classes, {
	...
	length: {
		select: "border px-3 py-2 rounded-lg border-gray-200 focus:border-slate-500 focus:ring focus:ring-gray-500 focus:ring-opacity-50 focus:outline-none"
	},
	processing: {
	...
	tbody: {
		row: 'even:bg-gray-50 hover:bg-slate-200',
		cell: 'p-3'
	},
	tfoot: {
		row: 'even:bg-gray-50',
